...
path d=c(0)+0.5..(0,1)..(-2,0)..(0,-1.3)..(2.5,0)..(1,1)..(0.9,0.3)..(1,0)..c(0.57)+(0,ep){W}..(-0.6,0)..(0,0)..cycle;
...
draw(Label("$C$",Relative(0.52)),p,heavygreen+linewidth(1),Arrow(Relative(0.5)));
...
label("$B_0$",c(0)+1.5ep*dir(45),orange);
//label("$C_{r}$",c(0)+1.65ep*dir(0),brown);
label("$D$",c(1)+ep*dir(180),blue);
