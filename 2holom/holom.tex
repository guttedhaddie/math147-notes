...
%An immediate difficulty is that you cannot easily \emph{graph} such a function!\medbreak
...
\boldsubsubsection{Basic 2D geometry with complex numbers}\phantomsection\label{pg:2dgeom}
...
Before we can differentiate, we need to understand limits and continuity. Much of this section should be treated as a reference, where we review without proof several preliminaries which are identical to (multivariable) real analysis.
...
%\href{https://www.math.uci.edu/~ndonalds/math147/complex-stereo.html}{\includegraphics[scale=1.6]{complex-stereo}}
\begin{center}
\href{https://www.math.uci.edu/~ndonalds/math147/complex-stereo.html}{\includegraphics[scale=0.85]{complex-stereo+0_0}}
\end{center}

% \begin{minipage}[t]{0.5\linewidth}\vspace{0pt}
% The \emph{Riemann sphere} gets its name because $\cl\C$ can be visualized as a \textcolor{blue}{sphere} with $\infty$ playing the role of the north pole. The `finite' portion of the sphere is identified bijectively with the \textcolor{Green}{equatorial plane} via the \href{https://en.wikipedia.org/wiki/Stereographic_projection}{\emph{stereographic projection}} $\pi:S^2\to\cl\C$: the image of $P$ is the intersection of the equatorial plane with the line through $P$ and $N=\pi^{-1}(\infty)$.
...
\subsection[Derivatives \& the Cauchy--Riemann Equations]{Derivatives \& the Cauchy--Riemann Equations}% (\S\,19-23)
