...
\footnotetext{Loosely speaking, a connected set consists of one `lump.' For topologists: almost all our domains of interest will be open, so there is no benefit to distinguishing between connectedness and path-connectedness.}
...
Laplace's equation is one of the most widely applied PDEs, used throughout mathematics and physics.
